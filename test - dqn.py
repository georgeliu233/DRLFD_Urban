...
def main():
  ...
  params = {
    ...
    'add_state':False, #use Mlp+Cnn Policy
    'obs_name':'birdeye',#basic options have 'camera' ; 'lidar' ; 'birdeye' ; 'state'#'use_control':False,
    'random_seed':10,
    'use_control':True
  }
  ...
  model = DQN(CnnPolicy,env,gamma=0.995)
  #model = DQN.load("C:/Users/24829/Desktop/rl_model_50000_steps.zip",env=env)
  checkpoint_callback = CheckpointCallback(save_freq=10000, save_path='./dqn_logs_xunhuan-new3/')
  #callback = CallbackList([checkpoint_callback, eval_callback])
  model.tensorboard_log="./tensorboard_dqn_log/DQN-new-3/"
  model.learn(total_timesteps=100000,callback=checkpoint_callback) 
  model.save("dqn_carla_new_4")
  '''
